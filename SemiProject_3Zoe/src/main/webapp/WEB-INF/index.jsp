...
<style>
	...
	.rolling_panel { position: relative; height: 150px; margin: 50px auto; padding: 0; border: 1px solid #c7c7c7; overflow: hidden; }
    .rolling_panel ul { position: absolute; margin-left: 500px; padding: 0; list-style: none; }
...
<div class="promotion_2" style="height:750px !important;">

	<h3 class="es_title" style="padding: 100px 0 50px 0; font-weight: bold; font-size: 30pt;">BEST 인기강의</h3>
	<div class="rolling_panel" style="height: 400px; ">
            <ul>
                <li class= "es_rolling" style="width: 450px; height: 400px; border:solid 1px red;"><a><img src="<%=request.getContextPath()%>/images/best1.png" style="width: 350px; height: 400px;" alt="배너이미지2" /></a></li>
                <li class= "es_rolling" style="width: 450px; height: 400px; border:solid 1px red;"><a><img src="<%=request.getContextPath()%>/images/best2.png" style="width: 350px; height: 400px;" alt="배너이미지2" /></a></li>
                <li class= "es_rolling" style="width: 450px; height: 400px; border:solid 1px red;"><a><img src="<%=request.getContextPath()%>/images/best3.png" style="width: 350px; height: 400px;" alt="배너이미지2" /></a></li>
                <li class= "es_rolling" style="width: 450px; height: 400px; border:solid 1px red;"><a><img src="<%=request.getContextPath()%>/images/best4.png" style="width: 350px; height: 400px;" alt="배너이미지2" /></a></li>
                <li class= "es_rolling" style="width: 450px; height: 400px; border:solid 1px red;"><a><img src="<%=request.getContextPath()%>/images/best5.png" style="width: 350px; height: 400px;" alt="배너이미지2" /></a></li>
            </ul>
        </div>
...
<div class="grayBox compad" style="background-color:#ffffff!important;">
    <div class="w1230">
