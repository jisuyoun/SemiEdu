...
<script type="text/javascript">
	...
	$(document).ready (function(){
		...
		$("button#btnConfirmCode").click(function(){
			...
			frm.action = "<%= ctxPath%>/login/sleeperVerifyCertification.go";
			frm.method = "post";
			frm.submit();
	...
	<div class="mem_cont">
		...
		<div class="passwd_cont">
			<div class="myinfo_cont refund_info email_cont">
				...
				<h4 class="mem_tit marb20 inline">가입시 등록하신 이메일(<span style="color: green; font-size: 14pt; font-weight: bold;">${requestScope.email}</span>)로 인증코드가 발송됩니다.</h4>
				<dl>
					<dt>마지막 접속일: </dt>
				...
				<input type="hidden" name="lastLogdate" value="${requestScope.lastLogdate}"/>
				<input type="hidden" name="idleDate" value="${requestScope.idleDate}"/>
		...
		<div id="div_findResult" class="myinfo_cont refund_info email_cont">	
				...
				<p style="text-align:center; margin-top:20px;">
	  				<button type="submit" id="btnFind" style="background-color:#1bceb8; color:white; border-radius:30px; width:155px; border:none; padding:10px;">인증번호 받기</button>
  				</p>
